    ...
    <div className="max-w-2xl mx-auto p-4">
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-3xl font-bold tracking-tight">ประเภทงาน</h1>
        </div>
        <Button onClick={handleAddJobType} className="gap-2 px-4 py-2 rounded-full shadow bg-primary text-white hover:bg-primary/90">
