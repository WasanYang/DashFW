...
const schema = z.object({
  ...
  fastwork_link: z.string().url('Fastwork link must be a valid URL').or(z.literal('')),
...
const socialPlatforms = ['Facebook', 'Instagram', 'Line', 'Phone', 'Website', 'Other'];
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-grow">
                      <FormControl>
                        <Input placeholder="Username, ID, or Phone" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Additional details or notes about the client..." rows={5} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
